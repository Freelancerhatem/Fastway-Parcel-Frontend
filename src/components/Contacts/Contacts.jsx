...
const Contacts = () => {
    ...
    return (
        <div name='contact_us' className="mt-12 h-[70vh]">
            <SectionTitle header={'Contact Us'} text={'Any questions or feedback, please feel free to reach out to us.'}></SectionTitle>
            <div className="grid grid-cols-1 lg:grid-cols-5 ">
                <div className="flex  bg-cover bg-no-repeat rounded shadow  lg:col-span-3 mx-auto lg:mx-0  lg:pl-12">
                    <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
                        <form ref={form} onSubmit={sendEmail} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
                                ...
                                <div className="flex flex-col md:flex-row mx-auto lg:mx-0 gap-4">
                                    <div className="relative h-11 w-[200px] lg:min-w-[320px] ">
                                        <input name='Fname' type="text" required
                                            className="peer h-full w-full rounded-md border  border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-[#1db7ad] focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                            placeholder=" "
                                        />
                            ...
                            <button
                                className="mt-20 w-96  md:ml-0 bg-gradient-to-tr from-[#1db7ad] to-[#72f4eb] block  select-none rounded-lg  py-3 px-3 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md  transition-all hover:shadow-lg hover:shadow-[#1db7ad]/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                type="submit"
                ...
                <div className=" w-full lg:col-span-2 ">
                    ...
                    <div className='flex flex-col justify-center items-center mt-4'>
                        ...
                        <p className=' text-xs lg:text-base'>Dhaka-1209,BD</p>
