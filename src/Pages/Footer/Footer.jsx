...
const Footer = () => {
  ...
  <nav className="text-xs lg:text-base flex lg:flex-col mt-6 lg:mt-0">
    <header className="flex gap-2 lg:gap-0 lg:flex-col text">Company</header> 
...
<footer className="footer px-10 py-4 border-t bg-slate-100 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    <img className="w-32 h-12" src={img} alt="" />
    <p>FastWay Parcel Ltd. <br/>Providing Service since 1992</p>
  </aside> 
